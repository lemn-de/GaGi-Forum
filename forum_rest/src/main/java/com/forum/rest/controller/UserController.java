...
public class UserController extends BaseController {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "token", value = "发送给用户的唯一令牌",dataType = "String"),
            @ApiImplicitParam(name = "oldpsd",value = "旧的密码",dataType = "String"),
            @ApiImplicitParam(name = "newpsd",value = "新的密码",dataType = "String"),
    })
    @PutMapping("/password/{token}")
    public QuarkResult updatePassword(@PathVariable("token") String token, String oldpsd, String newpsd) {
        QuarkResult result = restProcessor(() -> {
